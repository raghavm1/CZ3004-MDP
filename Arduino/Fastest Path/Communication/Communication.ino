...
void motionSwitch(String input){
   ...
   if(len_command > 1 && len_command < 3){
    int rep = int(input[1]) - int('0');
   }else{
    int rep = (int(input[1]) - int('0'))*10 - int(input[0]) - int('0'); 
   }
   switch(a){
